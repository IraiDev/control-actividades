...
const Times = () => {
   ...
   return (
      <main className='pt-8 pb-5'>
         <header className='flex items-center justify-center gap-4 bg-white rounded-lg shadow-lg w-max py-2 px-3 mx-auto'>
            <label htmlFor='id_reset'>
               ...
               <span
                  className={`ml-2 cursor-pointer ${
                     !check && 'text-slate-400 line-through'
                  }`}>
                  Cobrables
               </span>
            </label>
                              ...
                              {item.usuarios.map((user, i) => (
                                 <Td
                                    ...
                                    <div className='w-full flex justify-around'>
                                       <span>
                                          {check
                                             ? hideValue(user.tiempos.mc)
                                             : hideValue(user.tiempos.mnc)}
                                       </span>
                                       <span>
                                          {check
                                             ? hideValue(user.tiempos.d5c)
                                             : hideValue(user.tiempos.d5nc)}
                                       </span>
                                       <span>
                                          {check
                                             ? hideValue(user.tiempos.d3c)
                                             : hideValue(user.tiempos.d3nc)}
                                       </span>
                                       <span>
                                          {check
                                             ? hideValue(user.tiempos.d1c)
                                             : hideValue(user.tiempos.d1nc)}
                                       </span>
                                    </div>
                                 </Td>
                              ))}
