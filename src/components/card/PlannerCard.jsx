  ...
  return (
    ...
    >
      ...
      <header className='grid grid-cols-2 '>
        <section>
          <p>
            <span className='font-semibold capitalize mr-1'>plan:</span>
            {plan}
          </p>
          <p>
            <span className='font-semibold capitalize mr-1'>fecha:</span>
            {moment(createdDateTime).format('DD-MM-yyyy')}
          </p>
          <p>
            <span className='font-semibold capitalize mr-1'>estado:</span>
            {state}
          </p>
        </section>
      ...
      <section className='bg-black bg-opacity-5 p-1.5 my-2 rounded-md'>
        <h5 className='capitalize  font-semibold'>descripcion</h5>
        <p
          className={`
