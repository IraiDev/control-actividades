...
const ActivityCard = (props) => {
   ...
   const isChildrenAndFatherAndCoor =
      props.es_hijo === 1 && props.es_padre === 1 && props.id_tipo_actividad === 4
   ...
   const openModalClone = () => {
      ...
      setActOptions({
         ...
         sp:
            data.id_sub_proy !== 0
               ? optionsArray.subProjects.find((item) => item.value === data.id_sub_proy)
               : actOptions.sp,
         ur:
            data.id_revisor !== 0
               ? optionsArray.users.find((item) => item.id === data.id_revisor)
               : actOptions.ur,
   ...
   const validation = () => {
      ...
      const vRevisor =
         actOptions.ta?.value === 1
            ? actOptions.ur?.value === undefined
               ? true
               : actOptions.ur?.value === 0
            : false
      const vRdisE =
         actOptions.ta?.value === 1 ? actOptions.ur?.id === actOptions.ue?.id : false
      const vTipo_actividad =
         actOptions.ta?.value === 0 || actOptions.ta?.value === undefined
   ...
   const onClone = async () => {
      ...
      actOptions?.ta?.value === 1 &&
         actOptions?.ur &&
         formData.append('revisor', actOptions.ur.id)
   ...
   return (
      <>
         ...
         >
            {isRestricted && (
               <span
                  className="absolute flex items-center justify-center mx-auto h-7 w-7 top-3 right-12"
            ...
            <CardContent title={props.actividad} cardNum={numberCard}>
               <CardSection colCount={3}>
                  ...
                  <section className="capitalize">
                     ...
                     <P
                        tag="estado"
                        value={
                           optionsArray?.status?.find((st) => st.value === estado)
                              .tooltip || ''
                        }
                     />
                  ...
                  <aside className="pl-3 capitalize">
                     ...
                     <span className="flex gap-1 rounded max-w-max">
                        <strong>ID:</strong>
                        <p
                           className={`
                     ...
                     <P
                        tag="ticket"
                        value={
                           props.num_ticket_edit === 0 ? '- -' : props.num_ticket_edit
                        }
                     />
                  </aside>
               </CardSection>
               ...
               <CardSection subtitle="descripcion">
                  <p className="p-2 whitespace-pre-wrap rounded-md bg-black/5 overflow-custom max-h-36 mix-blend-luminosity">
                     {props.func_objeto}
                  </p>

                  <div className="flex flex-wrap gap-3">
                     <Tag hideIcon>Tipo: {props.desc_tipo_actividad}</Tag>
                     ...
                     {props.notas.length > 0 && (
                        <Tag>Tiene {props.notas.length} notas</Tag>
                     )}
                  </div>
               </CardSection>
            </CardContent>
            ...
            <CardFooter>
               ...
               >
                  <i
                     className={ESTADO_play ? 'fas fa-pause fa-sm' : 'fas fa-play fa-sm'}
                  />
               </Button>
               ...
               <ul className="max-h-56 overflow-custom">
                  {props.notas.length > 0 ? (
                     props.notas.map((note) => (
                        ...
                        >
                           <span
                              className="w-full text-gray-600 transition duration-200 cursor-pointer hover:text-blue-400"
                              onClick={() =>
                                 setValues({
                                    desc: note.desc_nota,
                                    id: note.id_nota,
                     ...
                     <li className="ml-2 text-sm text-gray-500">No hay notas...</li>
                  )}
               </ul>
               <TextArea
         ...
         {modalClone && (
            <Modal
               ...
               onClose={onCloseModals}
               padding="p-4 md:p-6"
               title={`Clonar actividad: ${props.id_det}, ${
                     ...
                     <aside className="mt-0.5 grid">
                        <div className="border-2 border-amber-200 rounded p-0.5 mb-3">
                           <CloneSelect
                              ...
                              options={
                                 isFather && isTicket
                                    ? optionsArray?.activity_type.filter(
                                         (item) => item.value !== 1 && item.value !== 5
                                      )
                                    : optionsArray?.activity_type?.filter(
                                         (item) => item.value !== 5 && item.value !== 3
                                      )
                              }
                              value={actOptions.ta}
                              onChange={(option) =>
